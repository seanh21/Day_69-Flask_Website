...
gravatar = Gravatar(app, size=200, rating='g')
...
class BlogPost(db.Model):
    ...
    comment_section = relationship("Comment", back_populates="main_post")
...
class Comment(db.Model):
    ...
    main_post = relationship("BlogPost", back_populates="comment_section")
